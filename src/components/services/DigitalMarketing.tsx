...
export default function DigitalMarketing({ onBack }: { onBack: () => void }) {
  const features = [
    { icon: Target, title: 'Strategic Planning', description: 'Data-driven strategies tailored to your business goals and target audience' },
    { icon: BarChart3, title: 'Performance Analytics', description: 'Real-time tracking and detailed reports to measure ROI and campaign effectiveness' },
    { icon: TrendingUp, title: 'Growth Optimization', description: 'Continuous optimization to maximize conversions and minimize acquisition costs' },
    { icon: Zap, title: 'Multi-Channel Campaigns', description: 'Integrated campaigns across email, display, and retargeting channels' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-16">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6">
            Digital <span className="text-purple-400">Marketing</span>
          </h1>
          <p className="text-xl text-gray-300 max-w-3xl">
            Comprehensive digital marketing strategies designed to boost your online presence, reach your target audience, and drive measurable conversions that accelerate business growth.
          </p>
        </div>
            ...
            <div className="relative bg-gradient-to-br from-gray-900/80 to-black/80 backdrop-blur-xl border border-gray-800 rounded-3xl p-12">
              <div className="space-y-6">
                ...
                <ul className="space-y-4">
                  {['Campaign Strategy & Planning', 'Keyword Research & Analysis', 'Ad Copy & Creative Development', 'Landing Page Optimization', 'Budget Management & Allocation', 'Performance Tracking & Reporting'].map((item, i) => (
        ...
        <div className="bg-gradient-to-r from-purple-600/20 via-violet-600/20 to-purple-600/20 border border-purple-500/30 rounded-3xl p-12">
          <h3 className="text-3xl font-bold text-white mb-6">Our Process</h3>
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { step: 1, title: 'Discovery', desc: 'Understand your goals and audience' },
              { step: 2, title: 'Strategy', desc: 'Develop comprehensive campaign plan' },
              { step: 3, title: 'Execution', desc: 'Launch and manage campaigns' },
              { step: 4, title: 'Optimize', desc: 'Analyze and improve performance' },
            ].map((item, i) => (
